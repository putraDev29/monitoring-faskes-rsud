...
class _ExaminationFormPageState extends State<ExaminationFormPage> {
  ...
  /// Tampilkan time-picker dan tulis hasilnya ke [controller] sebagai "HH:mm"
  Future<void> _pickTime(TextEditingController controller) async {
    // Parse nilai yang sudah ada agar picker dibuka di posisi yang benar
  ...
  Future<void> _submit() async {
    ...
    try {
      // Fallback ke nilai lama jika field jam tidak diubah saat edit
                ...
                children: [
                  Expanded(
                    child: _buildTimeField(
                      ...
                      label: 'Jam Buka',
                      hint: '08:00',
                      isRequired: !_isEdit, // tidak wajib saat edit
                    ),
                  ),
                  const SizedBox(width: 12),
                  Column(
  ...
  Widget _buildTimeField({
    ...
    required String label,
    required String hint,
    bool isRequired = true, // tambah parameter ini
  }) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        TextFormField(
          ...
          validator: (v) {
            // Jika edit dan field sudah terisi dari data sebelumnya, skip validasi
